...
int main(){
    ...
    bool yf=1; string yn="ls";
    if(yf){// yes no 解答なら yf=1 yn を ls で大文字小文字調節 bl が　1　なら　yes
        if(yn=="ls") if(bl) cout << "Yes";  else cout << "No";
        if(yn=="ll") if(bl) cout << "YES";  else cout << "NO";
        if(yn=="ss") if(bl) cout << "yes";  else cout << "no";
        pp;
    }
